...
async def generate_response(
    ...
    Args:
        ...
        has_data: Whether relevant data was found (bypassed — always treated as True)
    ...
    # --- System message (dilonggarkan, aturan TOLAK dihapus) ---
    system_msg = f"""Kamu adalah asisten virtual untuk sistem Satu Data Pertahanan {settings.ASSISTANT_SCOPE}.{category_info}

ATURAN:
1. JAWAB semua pertanyaan pengguna secara informatif dan membantu
2. Jawaban RINGKAS tapi INFORMATIF (3-5 kalimat untuk pertanyaan umum, lebih detail jika diminta)
3. Untuk sapaan: jawab 1 kalimat saja
4. Jika ada daftar INFO SISTEM di atas, GUNAKAN informasi tersebut untuk menjawab pertanyaan umum tentang data yang tersedia
...
"""
    ...
    # --- Bangun user message (bypass has_data: selalu gunakan path data dari v_detail_data_terbuka) ---
    user_content = f"""Data yang ditemukan dari sistem (v_detail_data_terbuka):
...
5. Jika context kosong atau tidak ada data → Informasikan kepada user dan sarankan kata kunci alternatif berdasarkan INFO SISTEM
